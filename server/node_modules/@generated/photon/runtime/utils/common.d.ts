...
export declare function stringifyGraphQLType(
...
export declare function getSuggestion(
  str: string,
  possibilities: string[],
): string | null
export declare function stringifyInputType(
  input: string | DMMF.InputType | DMMF.Enum,
  greenKeys?: boolean,
): string
export declare function getInputTypeName(
  input: string | DMMF.InputType | DMMF.SchemaField | DMMF.Enum,
): string
export declare function getOutputTypeName(
  input: string | DMMF.OutputType | DMMF.SchemaField | DMMF.Enum,
): string
export declare function inputTypeToJson(
  input: string | DMMF.InputType | DMMF.Enum,
  isRequired: boolean,
  nameOnly?: boolean,
): string | object
export declare function destroyCircular(from: any, seen?: any[]): any
export declare function unionBy<T>(
  arr1: T[],
  arr2: T[],
